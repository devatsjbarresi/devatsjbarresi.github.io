...
parent: Guide
nav_order: 4
permalink: /documentation/guide/filter-builder/
---
...
{: .warning }
> **Known Issue:** Protocol and manufacturer filters are currently experiencing some bugs which may require you to manually edit the display filter bar to achieve the desired result. See [Manual Editing](#manual-editing-of-filter-bar) below for guidance.
...
ShowShark includes a filter builder under **Tools > ShowShark Filter Builder...** to help create Wireshark display filters without needing to know the full filter syntax.
...
Go to **Tools > ShowShark Filter Builder...** in Wireshark:
